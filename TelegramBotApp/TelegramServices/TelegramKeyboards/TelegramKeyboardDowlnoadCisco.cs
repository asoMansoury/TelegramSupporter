...
{
    internal class TelegramKeyboardDowlnoadCisco : ITelegramKeyBoard
    {
        ...
        public TelegramKeyboardDowlnoadCisco()
        {
        ...
        {
            var prefix = CommandTypesEnum.DownloadCiscoApp.GetDescription();
            var model = (T as UserChangeServer);

            var accounts = new List<AccountTypes>();
            accounts.Add(new AccountTypes
            {
                Code = CiscoAppTypes.Android.GetDescription(),
                Name = "آندروید"
            });
            accounts.Add(new AccountTypes
            {
                Code = CiscoAppTypes.IPhone.GetDescription(),
                Name = "آیفون"
            });
            accounts.Add(new AccountTypes
            {
                Code = CiscoAppTypes.Wdinwos.GetDescription(),
                Name = "ویندوز"
            });
