...
{
    public class DownloadCiscoApp : BaseServiceAbstract, IBaseService
    {

        public DownloadCiscoApp(TelegramBotClient client) : base(client)
        {
        }
        ...
        public Task Run(Stack<Update> stackForMessage, Update Item, string message, User? From, long chatId)
        {
            ...
            var KeyBoard = TelegramKeyboardGeneratorFactory.GenerateKeyBoard(CommandsEnum.Cisco);
